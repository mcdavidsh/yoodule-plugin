<?php
/**
 * Plugin Name: Yoodule Plugin
 * Plugin URI: https://github.com/mcdavidsh/yoodule-plugin
...
add_action('wp_ajax_datatables_endpoint', 'yoodule_fetch_stripe_data'); //logged in
add_action('wp_ajax_no_priv_datatables_endpoint', 'yoodule_fetch_stripe_data'); //not logged in
